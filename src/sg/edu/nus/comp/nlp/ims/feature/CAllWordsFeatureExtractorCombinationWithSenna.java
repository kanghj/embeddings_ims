...
import sg.edu.nus.comp.nlp.ims.feature.embeddings.CWordEmbeddingsSentenceSumFeatureExtractor;
import sg.edu.nus.comp.nlp.ims.feature.embeddings.ScaledSennaWordEmbeddings;
import sg.edu.nus.comp.nlp.ims.feature.embeddings.ScaledWord2VecWordEmbeddings;
...
public class CAllWordsFeatureExtractorCombinationWithSenna extends CFeatureExtractorCombination {
	public CAllWordsFeatureExtractorCombinationWithSenna() throws IOException {
		...
		//this.m_FeatureExtractors.add(new CWordEmbeddingsSentenceMultFeatureExtractor(SizeScaledDependencyWordEmbeddings.instance()));

		this.m_FeatureExtractors.add(new CWordEmbeddingsSentenceSumFeatureExtractor(ScaledSennaWordEmbeddings.instance()));
