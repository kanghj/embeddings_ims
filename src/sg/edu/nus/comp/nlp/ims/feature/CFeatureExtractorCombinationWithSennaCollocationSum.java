...
import sg.edu.nus.comp.nlp.ims.feature.embeddings.CSennaCollocationContextSumFeatureExtractor;
 ...
 */
public class CFeatureExtractorCombinationWithSennaCollocationSum extends CFeatureExtractorCombination {
	public CFeatureExtractorCombinationWithSennaCollocationSum() throws IOException {
...
//		this.m_FeatureExtractors.add(new CWordEmbeddingsWindowSumFeatureExtractor(ScaledDependencyWordEmbeddings.instance()));
	...
	public CFeatureExtractorCombinationWithSennaCollocationSum(
