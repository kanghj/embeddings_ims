...
public class CWordEmbeddingsSentenceSumFeatureExtractor implements IFeatureExtractor {
     ...
     * constructor
     */
    public CWordEmbeddingsSentenceSumFeatureExtractor() {
        model = ScaledSennaWordEmbeddings.instance();

    }
    public CWordEmbeddingsSentenceSumFeatureExtractor(WordEmbeddings embeddings) {
        model = embeddings;
  ...
  //      System.out.println(key);
    ...
    public boolean setCurrentInstance(int p_Index) {
        if (this.validIndex(p_Index)) {
            ...
            //System.out.println("PINDEX " + p_Index);
            //System.out.println("SENT LENGTH " + this.m_Sentence.size());
