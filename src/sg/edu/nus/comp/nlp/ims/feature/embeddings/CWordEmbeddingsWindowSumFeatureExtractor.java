...
public class CWordEmbeddingsWindowSumFeatureExtractor implements IFeatureExtractor {
     ...
     * constructor
     */
    public CWordEmbeddingsWindowSumFeatureExtractor() {
        model = ScaledSennaWordEmbeddings.instance();

    }
    public CWordEmbeddingsWindowSumFeatureExtractor(WordEmbeddings embeddings) {
        model = embeddings;
    ...
    public IFeature getNext() {
        ...
        double totalValue = getStartValue();

        //System.out.print(": " + this.m_Sentence.getItem(this.m_IndexInSentence) + "  " + key + "  ... ");
        for (int i = Math.max(m_IndexInSentence - m_windowSize, 0);
                 i < Math.min(m_IndexInSentence + m_windowSize, this.m_Sentence.size());
                 i++) {
           ...
           // System.out.print(lemmaInSentence);
            ...
            totalValue = updateValueForDimensionFeature(totalValue, value);
        }
  //      System.out.println(key);
    ...
    protected String formName( int dimensionIndex) {
        return ("CWSum_" + String.valueOf(dimensionIndex)).intern();
    }
